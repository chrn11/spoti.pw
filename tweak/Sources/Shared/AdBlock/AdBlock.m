...
// Both lists are EeveeSpotify's, kept to the flags this Spotify has. The three sponsored-context
// entries the 9.1.78 list named are gone: this client no longer asks for them, and the 9.1.8x ad
// pipelines found in its binary (the Swift ad base and element kit, the in-stream head unit, the
// now playing bar's ads interaction handler, the ad on app open's own service) take their place.
static NSString *const adFlags[] = {
    @"ios-feature-adonappopen.enabled",
    @"ios-feature-adonappopen.cta_card_enabled",
    @"ios-feature-adsbase.enable_swift_ad_entity_factory",
    @"ios-feature-adsbase.enable_swift_ads_base_supporting_models",
    @"ios-feature-adsinstrumentation.enable_video_ad_observer_v2",
    @"ios-feature-adssponsoredcontext.enable_sponsored_playlist_horizontal_video",
    @"ios-feature-instreamads.new_head_unit_enabled",
    @"ios-feature-instreamads.screenshot_detection_enabled",
    @"ios-feature-leavebehindadsbase.unified_leavebehind_see_all_enabled",
    @"ios-feature-nowplayingbar.ads_interaction_handler_enabled",
    @"ios-feature-search.sponsorship_label_enabled",
    @"ios-home-evopage-impl.sponsorship_label_enabled",
    @"ios-jam-adsdisclaimersheetpage-impl.ads_disclaimer_sheet_enabled",
...
static NSString *const upsellFlags[] = {
    ...
    @"ios-feature-nowplaying-modes.video_first_skip_limit_upsell",
    @"ios-content-windowing.enable_track_preview_upsell",
    @"ios-feature-magpie.upsellability_enabled",
    @"ios-feature-bluejay.schedule_prompt_capped_upsell_enabled",
    @"ios-reinventfree-downloadupsellpage-impl.contextual_page_enabled",
